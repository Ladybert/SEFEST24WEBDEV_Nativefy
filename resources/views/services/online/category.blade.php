<x-app-layout>
    <div class="services-list px-4 md:px-8">
        ...
        <div class="grid lg:grid-cols-4 md:grid-cols-3 grid-cols-2 gap-4 mt-4">
            ...
            <a href="/checkout" class="service-card bg-white rounded-lg transition duration-300 p-2 border hover:border-gray-300 border-white">
                ...
                <div class="card-body p-2">
                    ...
                    <p class="text-gray-600 mb-2">Rp. 250.000</p>
            ...
            <a href="/checkout" class="service-card bg-white rounded-lg transition duration-300 p-2 border hover:border-gray-300 border-white">
                <img src="https://via.placeholder.com/250" alt="Product Image" class="w-full h-40 object-cover rounded-md">
                <div class="card-body p-2">
                    <h2 class="text-lg font-semibold mb-2">Jasa Kebersihan Rumah</h2>
