<x-app-layout>
    <div class="all-services">
        ...
        <div class="up-service grid w-full grid-cols-1 md:grid-cols-2 gap-4 mt-4">
            <div class="catgeory rounded-md">
                <div class="catgeory-title">
                    <h1 class="text-xl font-semibold">Kategori Pilihan</h1>
                </div>
                <div class="grid grid-cols-2 gap-2 mt-3">
                    <a href="/category/desain" class="flex items-center p-3 bg-gradient-to-r from-orange-400 to-orange-300 text-gray-800 rounded-lg hover:from-orange-500 hover:to-orange-400 transition duration-300">
                        <div class="flex-grow">
                    ...
                    <a href="/category/rumah-tangga" class="flex items-center p-3 bg-gradient-to-r from-green-400 to-green-300 text-gray-800 rounded-lg hover:from-green-500 hover:to-green-400 transition duration-300">
                        <div class="flex-grow">
                    ...
                    <a href="/category/otomotif" class="flex items-center p-3 bg-gradient-to-r from-yellow-400 to-yellow-300 text-gray-800 rounded-lg hover:from-yellow-500 hover:to-yellow-400 transition duration-300">
                        <div class="flex-grow">
                    ...
                    <a href="/category/elektronik" class="flex items-center p-3 bg-gradient-to-r from-blue-400 to-blue-300 text-gray-800 rounded-lg hover:from-blue-500 hover:to-blue-400 transition duration-300">
                        <div class="flex-grow">
        ...
        <div class="up-services mt-8">
            <div class="titile">
                <h1 class="text-xl mb-2 font-semibold">Layanan teratas</h1>
            </div>
            <div class="ads-services flex overflow-x-auto p-2 no-scrollbar">
