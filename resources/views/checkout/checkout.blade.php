<x-checkout-layout>
    ...
    <div class="checkout-content w-full p-4 md:p-4 lg:p-8 md:mt-16">
        <div class="checkout-content-wrapper flex flex-col md:flex-col lg:flex-row gap-2 w-full">
            <!-- Service Photo -->
            <div class="service-photo w-full lg:w-2/3 h-96 rounded-lg overflow-hidden">
            ...
            <!-- Service Checkout -->
            <div class="service-checkout w-full lg:w-1/3 rounded-md h-full">
                <form action="" method="POST">
                    ...
                    <div class="checkout-button mt-4 w-full">
                        <button type="submit" class="bg-black text-white hover:bg-gray-800 py-2 px-4 rounded hover:bg-green-700 transition-all w-full">Buat pesanan</button>
                    </div>
                </form>
            </div>
        </div>
